...
$queryParam = New-ParamCompleter -Name q -LongName query -Description $msg._query -Arguments @{ Name = 'query' }
$manifestParam = New-ParamCompleter -Name m -LongName manifest -Description $msg._manifest -Arguments @{ Name = 'manifest'; Type = 'File' }
$idParam = New-ParamCompleter -LongName id -Description $msg._id -Arguments @{ Name = 'id' }
$nameParam = New-ParamCompleter -LongName name -Description $msg._name -Arguments @{ Name = 'name' }
$monikerParam = New-ParamCompleter -LongName moniker -Description $msg._moniker -Arguments @{ Name = 'moniker' }
$versionParam = New-ParamCompleter -Name v -LongName version -Description $msg._version -Arguments @{ Name = 'version' }
$archParam = New-ParamCompleter -Name a -LongName architecture -Description $msg._arch -Arguments @{ Name = 'architecture'; Candidates = "x86","x64","arm","arm64" }
$logParam = New-ParamCompleter -Name o -LongName log -Description $msg._log -Arguments @{ Name = 'path'; Type = 'File' }
$verboseLogsParam = New-ParamCompleter -LongName verbose,verbose-logs -Description $msg._verbose_logs
$sourceParam = New-ParamCompleter -Name s -LongName source -Description $msg._source -Arguments @{ Name = 'source' }
$localeParam = New-ParamCompleter -LongName locale -Description $msg._locale -Arguments @{ Name = 'locale' }
$customParam = New-ParamCompleter -LongName custom -Description $msg.install_custom -Arguments @{ Name = 'arguments' }
...
$headerParam = New-ParamCompleter -LongName header -Description $msg._header -Arguments @{ Name = 'header' }
$proxyParam = New-ParamCompleter -LongName proxy -Description $msg._proxy -Arguments @{ Name = 'url' }
...
$interactiveParam = New-ParamCompleter -Name i -LongName interactive -Description $msg._interactive
$silentParam = New-ParamCompleter -Name h -LongName silent -Description $msg._silent
$installerTypeParam = New-ParamCompleter -LongName installer-type -Description $msg._installer_type -Arguments @{
    Name = 'type'; Candidates = "msix","msi","appx","exe","zip","inno","nullsoft","wix","burn","pwa"
}
$overrideParam = New-ParamCompleter -LongName override -Description $msg._override -Arguments @{ Name = 'arguments' }
$locationParam = New-ParamCompleter -Name l -LongName location -Description $msg._location -Arguments @{ Name = 'path'; Type = 'Directory' }
...
$authenticationModeParam = New-ParamCompleter -LongName authentication-mode -Description $msg._authentication_mode -Arguments @{
    Name = 'mode'; Candidates = "default","silent","interactive"
}
$authenticationAccountParam = New-ParamCompleter -LongName authentication-account -Description $msg._authentication_account -Arguments @{ Name = 'account' }
...
$sourceNameParam = New-ParamCompleter -Name n -LongName name -Description $msg.source_name -Arguments @{ Name = 'name' }
...
Register-NativeCompleter -Name winget -Description $msg.winget -SubCommands @(
    ...
    New-CommandCompleter -Name install -Aliases add -Description $msg.install -Parameters @(
        ...
        New-ParamCompleter -LongName dependency-source -Description $msg.install_dependency_source -Arguments @{ Name = 'source' }
    ...
    New-CommandCompleter -Name source -Description $msg.source -SubCommands @(
        New-CommandCompleter -Name add -Description $msg.source_add -Parameters @(
            $sourceNameParam
            New-ParamCompleter -Name a -LongName arg -Description $msg.source_arg -Arguments @{ Name = 'arg' }
            New-ParamCompleter -Name t -LongName type -Description $msg.source_type -Arguments @{ Name = 'type' }
            New-ParamCompleter -LongName trust-level -Description $msg.source_trust_level -Arguments @{ Name = 'level'; Candidates = "none","trusted" }
    ...
    New-CommandCompleter -Name search -Description $msg.search -Parameters @(
        ...
        $nameParam
        $monikerParam
        New-ParamCompleter -LongName tag -Description $msg.search_tag -Arguments @{ Name = 'tag' }
        New-ParamCompleter -LongName command,cmd -Description $msg.search_command -Arguments @{ Name = 'command' }
        $sourceParam
        New-ParamCompleter -Name n -LongName count -Description $msg.search_count -Arguments @{ Name = 'count' }
        $exactParam
        $acceptSourceAgreementsParam
        $headerParam
        $disableInteractivityParam
    ...
    New-CommandCompleter -Name list -Description $msg.list -Parameters @(
        ...
        $nameParam
        $monikerParam
        New-ParamCompleter -LongName tag -Description $msg.list_tag -Arguments @{ Name = 'tag' }
        New-ParamCompleter -LongName command,cmd -Description $msg.list_command -Arguments @{ Name = 'command' }
        $sourceParam
        New-ParamCompleter -Name n -LongName count -Description $msg.list_count -Arguments @{ Name = 'count' }
        $exactParam
        $acceptSourceAgreementsParam
        $headerParam
    ...
    New-CommandCompleter -Name upgrade -Description $msg.upgrade -Parameters @(
        ...
        $authenticationModeParam
        $authenticationAccountParam
        New-ParamCompleter -Name r -LongName recurse, all -Description $msg.upgrade_all
        New-ParamCompleter -Name u -LongName unknown, include-unknown -Description $msg.upgrade_include_unknown
    ...
    New-CommandCompleter -Name uninstall -Description $msg.uninstall -Parameters @(
        ...
        $nameParam
        $monikerParam
        New-ParamCompleter -LongName product-code -Description $msg.uninstall_product_code -Arguments @{ Name = 'code' }
        $versionParam
        $sourceParam
        $scopeParam
        $archParam
    ...
    New-CommandCompleter -Name hash -Description $msg.hash -Parameters @(
        New-ParamCompleter -Name f -LongName file -Description $msg.hash_file -Arguments @{ Name = 'file'; Type = 'File' }
    ...
    New-CommandCompleter -Name export -Description $msg.export -Parameters @(
        New-ParamCompleter -Name o -LongName output -Description $msg.export_output -Arguments @{ Name = 'file'; Type = 'File' }
        $sourceParam
    ...
    New-CommandCompleter -Name import -Description $msg.import -Parameters @(
        New-ParamCompleter -Name i -LongName import-file -Description $msg.import_import_file -Arguments @{ Name = 'file'; Type = 'File' }
    ...
    New-CommandCompleter -Name pin -Description $msg.pin -SubCommands @(
        ...
        New-CommandCompleter -Name add -Description $msg.pin_add -Parameters @(
            ...
            $sourceParam
            $exactParam
            New-ParamCompleter -Name v -LongName version -Description $msg.pin_version -Arguments @{ Name = 'version' }
    ...
    New-CommandCompleter -Name configure -Description $msg.configure -Parameters @(
        New-ParamCompleter -Name f -LongName file -Description $msg.configure_file -Arguments @{ Name = 'file'; Type = 'File' }
    ...
    New-CommandCompleter -Name download -Description $msg.download -Parameters @(
        $queryParam
        New-ParamCompleter -Name d -LongName download-directory -Description $msg.download_download_directory -Arguments @{ Name = 'path'; Type = 'Directory' }
        $manifestParam
        $idParam
        $nameParam
        $monikerParam
    ...
    # help
    New-CommandCompleter -Name help -Description $msg.help -NoFileCompletions -Arguments @{
        Name = 'cmd';
        Candidates = "install","show","source","search","list","upgrade","uninstall","hash","validate","settings","features","export","import","pin","configure","download"
    }

) -Parameters @(
    New-ParamCompleter -Name v -LongName version -Description $msg.version
