...
Register-NativeCompleter -Name usermod -Description $msg.usermod -Parameters @(
    ...
    New-ParamCompleter -ShortName d -LongName home -Description $msg.home -Arguments @{ Name = 'HOME_DIR'; Type = 'Directory' }
    ...
    New-ParamCompleter -ShortName l -LongName login -Description $msg.login -Arguments @{ Name = 'NEW_LOGIN' }
    ...
    New-ParamCompleter -ShortName s -LongName shell -Description $msg.shell -Arguments @{ Name = 'SHELL' }
    ...
    New-ParamCompleter -ShortName v -LongName add-subuids -Description $msg.add_subuids -Arguments @{ Name = 'FIRST-LAST' }
    New-ParamCompleter -ShortName V -LongName del-subuids -Description $msg.del_subuids -Arguments @{ Name = 'FIRST-LAST' }
    New-ParamCompleter -ShortName w -LongName add-subgids -Description $msg.add_subgids -Arguments @{ Name = 'FIRST-LAST' }
    New-ParamCompleter -ShortName W -LongName del-subgids -Description $msg.del_subgids -Arguments @{ Name = 'FIRST-LAST' }
    New-ParamCompleter -ShortName Z -LongName selinux-user -Description $msg.selinux_user -Arguments @{ Name = 'SEUSER' }
) -Arguments @{
    Name = 'LOGIN';
    Script = $userCompleter
}
