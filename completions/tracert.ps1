...
Register-NativeCompleter -Name tracert -Description $msg.tracert -CustomStyle $style -Parameters @(
    ...
    New-ParamCompleter -Name '-h','/h' -Description $msg.max_hops -Arguments @{ Name = 'maximum_hops' }
    New-ParamCompleter -Name '-j','/j' -Description $msg.source_route -Arguments @{ Name = 'host-list' }
    New-ParamCompleter -Name '-w','/w' -Description $msg.max_timeout -Arguments @{ Name = 'timeout' }
    New-ParamCompleter -Name '-R','/R' -Description $msg.reverse_route
    New-ParamCompleter -Name '-S','/S' -Description $msg.source_route_ipv6 -Arguments @{ Name = 'srcaddr' }
