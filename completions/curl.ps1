...
Register-NativeCompleter -Name curl -Description 'transfer a URL' -Parameters @(
    New-ParamCompleter -LongName abstract-unix-socket -Description $msg.'abstract-unix-socket' -VariableName 'PATH'
    New-ParamCompleter -LongName alt-svc -Description $msg.'alt-svc' -ArgumentType File -VariableName 'FILE'
    ...
    New-ParamCompleter -LongName cacert -Description $msg.'cacert' -ArgumentType File -VariableName 'FILE'
    New-ParamCompleter -LongName capath -Description $msg.'capath' -ArgumentType Directory -VariableName 'DIR'
    ...
    New-ParamCompleter -ShortName E -LongName cert -Description $msg.'cert' -VariableName 'CERT[:PASSWD]'
    New-ParamCompleter -LongName ciphers -Description $msg.'ciphers' -VariableName 'LIST'
    ...
    New-ParamCompleter -ShortName K -LongName config -Description $msg.'config' -ArgumentType File -VariableName 'FILE'
    New-ParamCompleter -LongName connect-timeout -Description $msg.'connect-timeout' -VariableName 'SECONDS'
    New-ParamCompleter -LongName connect-to -Description $msg.'connect-to' -VariableName 'HOST1:PORT1:HOST2:PORT2'
    New-ParamCompleter -ShortName C -LongName continue-at -Description $msg.'continue-at' -VariableName 'OFFSET'
    New-ParamCompleter -ShortName c -LongName cookie-jar -Description $msg.'cookie-jar' -ArgumentType File -VariableName 'FILE'
    New-ParamCompleter -ShortName b -LongName cookie -Description $msg.'cookie' -VariableName 'DATA|FILENAME'
    New-ParamCompleter -LongName create-dirs -Description $msg.'create-dirs'
    New-ParamCompleter -LongName crlf -Description $msg.'crlf'
    New-ParamCompleter -LongName crlfile -Description $msg.'crlfile' -ArgumentType File -VariableName 'FILE'
    New-ParamCompleter -LongName data-ascii -Description $msg.'data-ascii' -VariableName 'DATA'
    New-ParamCompleter -LongName data-binary -Description $msg.'data-binary' -VariableName 'DATA'
    New-ParamCompleter -LongName data-raw -Description $msg.'data-raw' -VariableName 'DATA'
    New-ParamCompleter -LongName data-urlencode -Description $msg.'data-urlencode' -VariableName 'DATA'
    New-ParamCompleter -ShortName d -LongName data -Description $msg.'data' -VariableName 'DATA'
    ...
    New-ParamCompleter -LongName dns-interface -Description $msg.'dns-interface' -VariableName 'INTERFACE'
    New-ParamCompleter -LongName dns-ipv4-addr -Description $msg.'dns-ipv4-addr' -VariableName 'ADDRESS'
    New-ParamCompleter -LongName dns-ipv6-addr -Description $msg.'dns-ipv6-addr' -VariableName 'ADDRESS'
    New-ParamCompleter -LongName dns-servers -Description $msg.'dns-servers' -VariableName 'ADDRESSES'
    New-ParamCompleter -LongName doh-url -Description $msg.'doh-url' -VariableName 'URL'
    New-ParamCompleter -ShortName D -LongName dump-header -Description $msg.'dump-header' -ArgumentType File -VariableName 'FILE'
    New-ParamCompleter -LongName egd-file -Description $msg.'egd-file' -ArgumentType File -VariableName 'FILE'
    New-ParamCompleter -LongName engine -Description $msg.'engine' -VariableName 'NAME'
    New-ParamCompleter -LongName expect100-timeout -Description $msg.'expect100-timeout' -VariableName 'SECONDS'
    ...
    New-ParamCompleter -LongName form-string -Description $msg.'form-string' -VariableName 'NAME=STRING'
    New-ParamCompleter -ShortName F -LongName form -Description $msg.'form' -VariableName 'NAME=CONTENT'
    New-ParamCompleter -LongName ftp-account -Description $msg.'ftp-account' -VariableName 'DATA'
    New-ParamCompleter -LongName ftp-alternative-to-user -Description $msg.'ftp-alternative-to-user' -VariableName 'COMMAND'
    ...
    New-ParamCompleter -ShortName P -LongName ftp-port -Description $msg.'ftp-port' -VariableName 'ADDRESS'
    ...
    New-ParamCompleter -LongName happy-eyeballs-timeout-ms -Description $msg.'happy-eyeballs-timeout-ms' -VariableName 'MILLISECONDS'
    ...
    New-ParamCompleter -ShortName H -LongName header -Description $msg.'header' -VariableName 'LINE'
    New-ParamCompleter -ShortName h -LongName help -Description $msg.'help' -Arguments 'all','category'
    New-ParamCompleter -LongName hostpubmd5 -Description $msg.'hostpubmd5' -VariableName 'MD5'
    ...
    New-ParamCompleter -LongName interface -Description $msg.'interface' -VariableName 'NAME'
    ...
    New-ParamCompleter -LongName keepalive-time -Description $msg.'keepalive-time' -VariableName 'SECONDS'
    New-ParamCompleter -LongName key-type -Description $msg.'key-type' -Arguments 'DER','PEM','ENG' -VariableName 'TYPE'
    New-ParamCompleter -LongName key -Description $msg.'key' -ArgumentType File -VariableName 'KEY'
    New-ParamCompleter -LongName krb -Description $msg.'krb' -Arguments 'clear','safe','confidential','private' -VariableName 'LEVEL'
    New-ParamCompleter -LongName libcurl -Description $msg.'libcurl' -ArgumentType File -VariableName 'FILE'
    New-ParamCompleter -LongName limit-rate -Description $msg.'limit-rate' -VariableName 'SPEED'
    New-ParamCompleter -ShortName l -LongName list-only -Description $msg.'list-only'
    New-ParamCompleter -LongName local-port -Description $msg.'local-port' -VariableName 'RANGE'
    ...
    New-ParamCompleter -LongName login-options -Description $msg.'login-options' -VariableName 'OPTIONS'
    New-ParamCompleter -LongName mail-auth -Description $msg.'mail-auth' -VariableName 'ADDRESS'
    New-ParamCompleter -LongName mail-from -Description $msg.'mail-from' -VariableName 'ADDRESS'
    New-ParamCompleter -LongName mail-rcpt -Description $msg.'mail-rcpt' -VariableName 'ADDRESS'
    New-ParamCompleter -ShortName M -LongName manual -Description $msg.'manual'
    New-ParamCompleter -LongName max-filesize -Description $msg.'max-filesize' -VariableName 'BYTES'
    New-ParamCompleter -LongName max-redirs -Description $msg.'max-redirs' -VariableName 'NUM'
    New-ParamCompleter -ShortName m -LongName max-time -Description $msg.'max-time' -VariableName 'SECONDS'
    ...
    New-ParamCompleter -LongName netrc-file -Description $msg.'netrc-file' -ArgumentType File -VariableName 'FILE'
    ...
    New-ParamCompleter -LongName noproxy -Description $msg.'noproxy' -VariableName 'LIST'
    New-ParamCompleter -LongName ntlm-wb -Description $msg.'ntlm-wb'
    New-ParamCompleter -LongName ntlm -Description $msg.'ntlm'
    New-ParamCompleter -LongName oauth2-bearer -Description $msg.'oauth2-bearer' -VariableName 'TOKEN'
    New-ParamCompleter -ShortName o -LongName output -Description $msg.'output' -ArgumentType File -VariableName 'FILE'
    New-ParamCompleter -LongName pass -Description $msg.'pass' -VariableName 'PHRASE'
    New-ParamCompleter -LongName path-as-is -Description $msg.'path-as-is'
    New-ParamCompleter -LongName pinnedpubkey -Description $msg.'pinnedpubkey' -VariableName 'HASHES'
    ...
    New-ParamCompleter -LongName preproxy -Description $msg.'preproxy' -VariableName '[PROTOCOL://]HOST[:PORT]'
    New-ParamCompleter -ShortName '#' -LongName progress-bar -Description $msg.'progress-bar'
    New-ParamCompleter -LongName proto-default -Description $msg.'proto-default' -VariableName 'PROTOCOL'
    New-ParamCompleter -LongName proto-redir -Description $msg.'proto-redir' -VariableName 'PROTOCOLS'
    New-ParamCompleter -LongName proto -Description $msg.'proto' -VariableName 'PROTOCOLS'
    ...
    New-ParamCompleter -LongName proxy-cacert -Description $msg.'proxy-cacert' -ArgumentType File -VariableName 'FILE'
    New-ParamCompleter -LongName proxy-capath -Description $msg.'proxy-capath' -ArgumentType Directory -VariableName 'DIR'
    New-ParamCompleter -LongName proxy-cert-type -Description $msg.'proxy-cert-type' -Arguments 'DER','PEM' -VariableName 'TYPE'
    New-ParamCompleter -LongName proxy-cert -Description $msg.'proxy-cert' -VariableName 'CERT[:PASSWD]'
    New-ParamCompleter -LongName proxy-ciphers -Description $msg.'proxy-ciphers' -VariableName 'LIST'
    New-ParamCompleter -LongName proxy-crlfile -Description $msg.'proxy-crlfile' -ArgumentType File -VariableName 'FILE'
    New-ParamCompleter -LongName proxy-digest -Description $msg.'proxy-digest'
    New-ParamCompleter -LongName proxy-header -Description $msg.'proxy-header' -VariableName 'LINE'
    ...
    New-ParamCompleter -LongName proxy-key -Description $msg.'proxy-key' -ArgumentType File -VariableName 'KEY'
    ...
    New-ParamCompleter -LongName proxy-pass -Description $msg.'proxy-pass' -VariableName 'PHRASE'
    New-ParamCompleter -LongName proxy-pinnedpubkey -Description $msg.'proxy-pinnedpubkey' -VariableName 'HASHES'
    ...
    New-ParamCompleter -LongName proxy-tls13-ciphers -Description $msg.'proxy-tls13-ciphers' -VariableName 'LIST'
    New-ParamCompleter -LongName proxy-tlsauthtype -Description $msg.'proxy-tlsauthtype' -VariableName 'TYPE'
    New-ParamCompleter -LongName proxy-tlspassword -Description $msg.'proxy-tlspassword' -VariableName 'STRING'
    New-ParamCompleter -LongName proxy-tlsuser -Description $msg.'proxy-tlsuser' -VariableName 'NAME'
    New-ParamCompleter -LongName proxy-tlsv1 -Description $msg.'proxy-tlsv1'
    New-ParamCompleter -ShortName U -LongName proxy-user -Description $msg.'proxy-user' -VariableName 'USER:PASSWORD'
    New-ParamCompleter -ShortName x -LongName proxy -Description $msg.'proxy' -VariableName '[PROTOCOL://]HOST[:PORT]'
    New-ParamCompleter -LongName proxy1.0 -Description $msg.'proxy1.0' -VariableName 'HOST[:PORT]'
    New-ParamCompleter -ShortName p -LongName proxytunnel -Description $msg.'proxytunnel'
    New-ParamCompleter -LongName pubkey -Description $msg.'pubkey' -ArgumentType File -VariableName 'KEY'
    New-ParamCompleter -ShortName Q -LongName quote -Description $msg.'quote' -VariableName 'COMMAND'
    New-ParamCompleter -LongName random-file -Description $msg.'random-file' -ArgumentType File -VariableName 'FILE'
    New-ParamCompleter -ShortName r -LongName range -Description $msg.'range' -VariableName 'RANGE'
    New-ParamCompleter -LongName raw -Description $msg.'raw'
    New-ParamCompleter -ShortName e -LongName referer -Description $msg.'referer' -VariableName 'URL'
    ...
    New-ParamCompleter -LongName retry-delay -Description $msg.'retry-delay' -VariableName 'SECONDS'
    New-ParamCompleter -LongName retry-max-time -Description $msg.'retry-max-time' -VariableName 'SECONDS'
    New-ParamCompleter -LongName retry -Description $msg.'retry' -VariableName 'NUM'
    New-ParamCompleter -LongName sasl-ir -Description $msg.'sasl-ir'
    New-ParamCompleter -LongName service-name -Description $msg.'service-name' -VariableName 'NAME'
    ...
    New-ParamCompleter -LongName socks4 -Description $msg.'socks4' -VariableName 'HOST[:PORT]'
    New-ParamCompleter -LongName socks4a -Description $msg.'socks4a' -VariableName 'HOST[:PORT]'
    ...
    New-ParamCompleter -LongName socks5-gssapi-service -Description $msg.'socks5-gssapi-service' -VariableName 'NAME'
    New-ParamCompleter -LongName socks5-gssapi -Description $msg.'socks5-gssapi'
    New-ParamCompleter -LongName socks5-hostname -Description $msg.'socks5-hostname' -VariableName 'HOST[:PORT]'
    New-ParamCompleter -LongName socks5 -Description $msg.'socks5' -VariableName 'HOST[:PORT]'
    New-ParamCompleter -ShortName Y -LongName speed-limit -Description $msg.'speed-limit' -VariableName 'SPEED'
    New-ParamCompleter -ShortName y -LongName speed-time -Description $msg.'speed-time' -VariableName 'SECONDS'
    ...
    New-ParamCompleter -LongName stderr -Description $msg.'stderr' -ArgumentType File -VariableName 'FILE'
    ...
    New-ParamCompleter -ShortName t -LongName telnet-option -Description $msg.'telnet-option' -VariableName 'OPT=VAL'
    New-ParamCompleter -LongName tftp-blksize -Description $msg.'tftp-blksize' -VariableName 'VALUE'
    New-ParamCompleter -LongName tftp-no-options -Description $msg.'tftp-no-options'
    New-ParamCompleter -ShortName z -LongName time-cond -Description $msg.'time-cond' -VariableName 'TIME'
    New-ParamCompleter -LongName tls-max -Description $msg.'tls-max' -Arguments '1.0','1.1','1.2','1.3' -VariableName 'VERSION'
    New-ParamCompleter -LongName tls13-ciphers -Description $msg.'tls13-ciphers' -VariableName 'LIST'
    New-ParamCompleter -LongName tlsauthtype -Description $msg.'tlsauthtype' -VariableName 'TYPE'
    New-ParamCompleter -LongName tlspassword -Description $msg.'tlspassword' -VariableName 'STRING'
    New-ParamCompleter -LongName tlsuser -Description $msg.'tlsuser' -VariableName 'USER'
    ...
    New-ParamCompleter -LongName trace-ascii -Description $msg.'trace-ascii' -ArgumentType File -VariableName 'FILE'
    New-ParamCompleter -LongName trace-time -Description $msg.'trace-time'
    New-ParamCompleter -LongName trace -Description $msg.'trace' -ArgumentType File -VariableName 'FILE'
    New-ParamCompleter -LongName unix-socket -Description $msg.'unix-socket' -VariableName 'PATH'
    New-ParamCompleter -ShortName T -LongName upload-file -Description $msg.'upload-file' -ArgumentType File -VariableName 'FILE'
    New-ParamCompleter -LongName url -Description $msg.'url' -VariableName 'URL'
    New-ParamCompleter -ShortName B -LongName use-ascii -Description $msg.'use-ascii'
    New-ParamCompleter -ShortName A -LongName user-agent -Description $msg.'user-agent' -VariableName 'NAME'
    New-ParamCompleter -ShortName u -LongName user -Description $msg.'user' -VariableName 'USER:PASSWORD'
    New-ParamCompleter -ShortName v -LongName verbose -Description $msg.'verbose'
    New-ParamCompleter -ShortName V -LongName version -Description $msg.'version'
    New-ParamCompleter -ShortName w -LongName write-out -Description $msg.'write-out' -VariableName 'FORMAT'
