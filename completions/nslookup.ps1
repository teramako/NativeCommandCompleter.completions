...
if ($IsWindows)
{
    Register-NativeCompleter -Name nslookup -Description $msg.nslookup -Parameters @(
        ...
        New-ParamCompleter -Name domain -Description $msg.domain -Arguments @{ Name = 'NAME' }
        New-ParamCompleter -Name port -Description $msg.port -Arguments @{ Name = 'PORT' }
        New-ParamCompleter -Name querytype,type -Description $msg.querytype -Arguments @{
            Name = 'TYPE'; Candidates = "A","AAAA","CNAME","MX","NS","PTR","SOA","SRV","TXT","ANY"
        }
        New-ParamCompleter -Name recurse -Description $msg.recurse
        New-ParamCompleter -Name norecurse -Description $msg.norecurse
        New-ParamCompleter -Name retry -Description $msg.retry -Arguments @{ Name = 'NUMBER' }
        New-ParamCompleter -Name timeout -Description $msg.timeout -Arguments @{ Name = 'NUMBER' }
        ...
        New-ParamCompleter -Name srchlist -Description $msg.srchlist -Arguments @{ Name = 'DOMAIN[/...]' }
    ...
    Register-NativeCompleter -Name nslookup -Description $msg.nslookup -Parameters @(
        ...
        New-ParamCompleter -Name querytype,type -Description $msg.querytype -Arguments @{
            Name = 'TYPE'; Candidates = @(
                ...
                "NS","NSEC","NSEC3","NSEC3PARAM","OPENPGPKEY","PTR","RRSIG","RP","SIG","SMIMEA","SOA","SRV",
                "SSHFP","SVCB","TA","TKEY","TLSA","TSIG","TXT","URI","ZONEMD","ANY"
            )
        }
        New-ParamCompleter -Name recurse -Description $msg.recurse
        New-ParamCompleter -Name norecurse -Description $msg.norecurse
        ...
        New-ParamCompleter -Name srchlist -Description $msg.srchlist -Arguments @{ Name = 'DOMAIN[/...]' }
        New-ParamCompleter -Name ndots -Description $msg.ndots -Arguments @{ Name = 'NUMBER' }
        New-ParamCompleter -Name '?' -Description $msg.help
    ) -NoFileCompletions
}
