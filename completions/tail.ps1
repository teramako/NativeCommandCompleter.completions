...
if ($LASTEXITCODE -eq 0) # GNU
{
    Register-NativeCompleter -Name tail -Parameters @(
        ...
        New-ParamCompleter -LongName max-unchanged-stats -Description $msg.gnu_max_unchanged_stats -VariableName 'N'
        New-ParamCompleter -LongName pid -Description $msg.gnu_pid -VariableName 'PID'
        ...
        New-ParamCompleter -ShortName s -LongName sleep-interval -Description $msg.gnu_sleep_interval -VariableName 'N'
