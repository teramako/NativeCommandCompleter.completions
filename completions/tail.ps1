...
if ($LASTEXITCODE -eq 0) # GNU
{
    Register-NativeCompleter -Name tail -Parameters @(
        ...
        New-ParamCompleter -LongName follow -Description $msg.gnu_follow -Arguments @{ Name = 'name|descriptor'; Nargs = '?'; Candidates = "name","descriptor" }
        ...
        New-ParamCompleter -LongName max-unchanged-stats -Description $msg.gnu_max_unchanged_stats -Arguments @{ Name = 'N' }
        New-ParamCompleter -LongName pid -Description $msg.gnu_pid -Arguments @{ Name = 'PID' }
        ...
        New-ParamCompleter -ShortName s -LongName sleep-interval -Description $msg.gnu_sleep_interval -Arguments @{ Name = 'N' }
