...
if ($LASTEXITCODE -eq 0) # GNU
{
    Register-NativeCompleter -Name cut -Parameters @(
        New-ParamCompleter -ShortName b -LongName bytes -Description $msg.bytes -VariableName 'LIST'
        New-ParamCompleter -ShortName c -LongName characters -Description $msg.gnu_characters -VariableName 'LIST'
        New-ParamCompleter -ShortName d -LongName delimiter -Description $msg.gnu_delimiter -VariableName 'DELIM'
        New-ParamCompleter -ShortName f -LongName fields -Description $msg.fields -VariableName 'LIST'
        ...
        New-ParamCompleter -LongName output-delimiter -Description $msg.gnu_output_delimiter -VariableName 'STRING'
...
{
    Register-NativeCompleter -Name cut -Parameters @(
        New-ParamCompleter -ShortName b -Description $msg.bytes -VariableName 'LIST'
        New-ParamCompleter -ShortName c -Description $msg.bsd_characters -VariableName 'LIST'
        New-ParamCompleter -ShortName d -Description $msg.bsd_delimiter -VariableName 'DELIM'
        New-ParamCompleter -ShortName f -Description $msg.fields -VariableName 'LIST'
