...
Register-NativeCompleter -Name fzf -Description 'command-line fuzzy finder' -Parameters @(
    ...
    New-ParamCompleter -LongName bind -Description $msg.bind -VariableName 'KEYBINDS'
    New-ParamCompleter -LongName cycle -Description $msg.cycle
    New-ParamCompleter -LongName keep-right -Description $msg.keep_right
    New-ParamCompleter -LongName scroll-off -Description $msg.scroll_off -VariableName 'LINES'
    ...
    New-ParamCompleter -LongName border-label -Description $msg.border_label -VariableName 'LABEL'
    New-ParamCompleter -LongName border-label-pos -Description $msg.border_label_pos -VariableName 'COL'
    New-ParamCompleter -LongName no-unicode -Description $msg.no_unicode
    New-ParamCompleter -LongName margin -Description $msg.margin -VariableName 'MARGIN'
    New-ParamCompleter -LongName padding -Description $msg.padding -VariableName 'PADDING'
    ...
    New-ParamCompleter -LongName separator -Description $msg.separator -VariableName 'STR'
    New-ParamCompleter -LongName no-separator -Description $msg.no_separator
    New-ParamCompleter -LongName scrollbar -Description $msg.scrollbar -VariableName 'CHAR'
    New-ParamCompleter -LongName no-scrollbar -Description $msg.no_scrollbar
    New-ParamCompleter -LongName prompt -Description $msg.prompt -VariableName 'STR'
    New-ParamCompleter -LongName pointer -Description $msg.pointer -VariableName 'STR'
    New-ParamCompleter -LongName marker -Description $msg.marker -VariableName 'STR'
    New-ParamCompleter -LongName header -Description $msg.header -VariableName 'STR'
    ...
    New-ParamCompleter -ShortName f -LongName filter -Description $msg.filter -VariableName 'STR'
